...
@ServerEndpoint(value = "/chatroom3/{username}")  // this is Websocket url
public class Chatroom3 {
    ...
    private final Logger logger = LoggerFactory.getLogger(Chatroom3.class);
    ...
    public void onOpen(Session session, @PathParam("username") String username) throws IOException {
        ...
        String message = "User:" + username + " has joined chatroom3.";
        broadcast(message);
    ...
    public void onMessage(Session session, String message) throws IOException {
        ...
        Message chatMessage = new Message(username, message, "Chatroom 3");
