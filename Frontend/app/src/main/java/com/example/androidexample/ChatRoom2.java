...
/**
 * ChatRoom2 activity that handles communication with the WebSocket server for chatroom 2 and displays messages in a chat interface.
 */
public class ChatRoom2 extends AppCompatActivity implements WebSocketListener {
     ...
     * Initializes UI components and sets up WebSocket connection for chatroom 2.
     *
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String serverUrl = "ws://coms-3090-070.class.las.iastate.edu:8080/chatroom2/" + username;  // Use correct server address
